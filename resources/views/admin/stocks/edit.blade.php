                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $stock->name) }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <input type="number" id="minimum_quantity" name="minimum_quantity"
                                    value="{{ old('minimum_quantity', $stock->minimum_quantity) }}" min="0" required
                            ...
                            <div class="space-y-1.5">
                                ...
                                <input type="text" id="unit" name="unit" value="{{ old('unit', $stock->unit) }}"
                                    placeholder="Contoh: pcs, pack, kg, liter" required
