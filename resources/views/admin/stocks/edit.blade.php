<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-text-muted t-size3 mt-1">Perbarui data stok inventori yang sudah terdaftar.</p>
            </div>
    ...
    <div class="max-w-[1400px] mx-auto space-y-6 anim-fade" x-data="{
        ...
        unit: '{{ old('unit', $stock->unit) }}',
        quantity: {{ old('quantity', $stock->quantity) }},
        minQty: {{ old('minimum_quantity', $stock->minimum_quantity) }}
    }">
        <!-- Breadcrumb -->
        <div class="flex items-center gap-2 t-size2 text-text-muted font-semibold">
            ...
            <span>›</span>
            <span class="text-text font-bold">Edit Stok</span>
        </div>
                    ...
                    <div class="bg-card border border-border rounded-3xl p-6 shadow-xs relative">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <input type="text" disabled placeholder="STK-{{ str_pad($stock->id, 4, '0', STR_PAD_LEFT) }}"
                    ...
                    <div class="bg-card border border-border rounded-3xl p-6 shadow-xs relative">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="space-y-1.5">
                                ...
                                <span class="t-size1 text-text-muted block">Jumlah stok yang tersedia</span>
                                @error('quantity')
                                    <span class="text-danger t-size2 font-semibold mt-1 block">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="space-y-1.5">
                                ...
                                <input type="date" disabled value="{{ $stock->updated_at->format('Y-m-d') }}"
                                    class="w-full bg-surface border border-border rounded-xl px-4 py-2.5 t-size4 outline-hidden text-text-muted cursor-not-allowed">
                            </div>
                        ...
                        <div class="bg-surface rounded-2xl p-5 border border-border space-y-4 flex flex-col items-center">
                            ...
                            <div class="w-full space-y-2.5 t-size3 border-t border-border/80 pt-4">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-bold text-text">STK-{{ str_pad($stock->id, 4, '0', STR_PAD_LEFT) }}</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-text-muted">Kategori</span>
                                    <span class="font-bold text-text">Bahan Baku</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="text-text-muted">Outlet</span>
                                    <span class="font-bold text-text">Cabang Utama</span>
                                </div>
                                <div class="flex justify-between">
                                ...
                                <div class="flex justify-between border-t border-border/50 pt-2.5">
                                    <span class="text-text-muted">Jumlah Stok</span>
