                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-surface/50 border border-border rounded-xl p-4 space-y-4">
                            <div>
                                ...
                                <p class="text-text-muted t-size2 mt-0.5">Biarkan kosong jika Anda tidak ingin mengubah
                                    kata sandi staf ini.</p>
                            </div>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <!-- Password -->
                                <div class="space-y-1.5">
                                    <label for="password" class="font-bold t-size3 text-text-muted">Kata Sandi
                                        Baru</label>
                        ...
                        @else
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <!-- Role assignment -->
                                <div class="space-y-1.5">
                                    <label for="role_id" class="font-bold t-size3 text-text-muted">Peran Hak Akses
                                ...
                                @if (auth()->user()->branch_id === null)
                                    <div class="space-y-1.5">
                                        ...
                                        <span class="text-text-muted t-size1 mt-1 block">Biarkan kosong jika ingin
                                            menyetel sebagai Super Admin global.</span>
                                        @error('branch_id')
                                            <span class="text-danger t-size2 font-semibold mt-1 block">{{ $message }}</span>
                                        @enderror
                                    </div>
