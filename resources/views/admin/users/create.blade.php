<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-text-muted t-size3 mt-1">Buat akun pengguna baru dan atur peran serta hak aksesnya.</p>
            </div>
    ...
    <div class="max-w-[1400px] mx-auto space-y-6 anim-fade" x-data="{
        ...
        get roleSummary() {
            ...
            if (!select) return 'Belum ada role dipilih';
        ...
        <div class="flex items-center gap-2 t-size2 text-text-muted font-semibold">
            ...
            <span>›</span>
            <span class="text-text font-bold">Tambah Pengguna</span>
        </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-6">
                            ...
                            <div class="flex flex-col items-center shrink-0">
                                ...
                                <div
                                    ...
                                    <span class="t-size1 font-bold text-primary">Upload Foto</span>
                            ...
                            <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div class="space-y-1.5">
                                    ...
                                    <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="nama@kravescan.com" required
                    ...
                    <div class="bg-card border border-border rounded-3xl p-6 shadow-xs">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-1.5" x-data="{ showPass: false }">
                                <label for="password" class="font-bold t-size3 text-text-muted">Password <span class="text-danger">*</span></label>
                                <div class="relative">
                                    <input :type="showPass ? 'text' : 'password'" id="password" name="password" required placeholder="Masukkan password"
