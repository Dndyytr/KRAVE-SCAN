                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" id="price" name="price" value="{{ old('price') }}" placeholder="Contoh: 28000" min="0" required
                ...
                <div class="space-y-4">
                    ...
                    <div x-data="{ 
                        ...
                        <div class="relative border-2 border-dashed border-border rounded-2xl p-6 hover:border-primary transition flex flex-col items-center justify-center bg-surface-alt/20 min-h-[160px]">
                            ...
                            <!-- Preview display -->
                            <div x-show="imagePreview" class="relative w-40 h-40 rounded-xl overflow-hidden border border-border shadow-xs z-10" style="display: none;">
