<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-text-muted t-size3 mt-1">Perbarui detail akses/role dan sesuaikan izin modul kustom.</p>
            </div>
    ...
    <div class="max-w-[1400px] mx-auto space-y-6 anim-fade" x-data="{
        ...
        <div class="flex items-center gap-2 t-size2 text-text-muted font-semibold">
            ...
            <span>›</span>
            <span class="text-text font-bold">Edit Akses</span>
        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-1.5 md:col-span-2">
                                ...
                                <input type="text" id="name" name="name" value="{{ old('name', $role->name) }}" required
                                    {{ in_array($role->name, ['admin', 'cashier', 'kitchen']) ? 'disabled' : '' }} placeholder="Contoh: Supervisor Outlet"
                                                            ...
                                                            @if ($perm)
                                                                <label
                                                                    ...
                                                                    <input type="checkbox" name="permissions[]" value="{{ $perm->id }}"
                                                                        @change="updateCount()" {{ in_array($perm->id, $rolePermissions) ? 'checked' : '' }}
