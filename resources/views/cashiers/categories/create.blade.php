<x-app-layout>
    ...
    <div class="max-w-3xl mx-auto space-y-6 anim-fade">
        ...
        <div class="bg-card border border-border rounded-2xl p-6 shadow-xs">
            <form action="{{ route('cashier.categories.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Contoh: Minuman Dingin" required autofocus
