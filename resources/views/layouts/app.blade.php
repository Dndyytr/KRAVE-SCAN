            ...
            <div class="flex-grow py-6 px-4 flex flex-col justify-between">
                <nav class="space-y-1">
                    ...
                    @if(Auth::user()->role?->name === 'admin')
                        ...
                        <a href="{{ route('admin.menus.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl font-semibold t-size4 transition {{ request()->routeIs('admin.menus*') ? 'bg-primary-soft text-accent' : 'text-text-muted hover:bg-surface hover:text-text' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                            </svg>
                            Daftar Menu
                        </a>
                        <a href="{{ route('admin.stocks.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl font-semibold t-size4 transition {{ request()->routeIs('admin.stocks*') ? 'bg-primary-soft text-accent' : 'text-text-muted hover:bg-surface hover:text-text' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    @if(Auth::user()->role?->name === 'admin')
                        <a href="{{ route('admin.orders.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl font-semibold t-size4 transition {{ request()->routeIs('admin.orders*') ? 'bg-primary-soft text-accent' : 'text-text-muted hover:bg-surface hover:text-text' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"></path>
                            </svg>
                            Daftar Pesanan
                        </a>
                        <a href="{{ route('admin.transactions.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl font-semibold t-size4 transition {{ request()->routeIs('admin.transactions*') ? 'bg-primary-soft text-accent' : 'text-text-muted hover:bg-surface hover:text-text' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    @if(Auth::user()->role?->name === 'admin')
                        ...
                        <a href="{{ route('admin.users.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl font-semibold t-size4 transition {{ request()->routeIs('admin.users*') ? 'bg-primary-soft text-accent' : 'text-text-muted hover:bg-surface hover:text-text' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path>
                            </svg>
                            Kelola Staf / Cabang
                        </a>
                        <a href="{{ route('admin.reports.sales') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl font-semibold t-size4 transition {{ request()->routeIs('admin.reports.sales') ? 'bg-primary-soft text-accent' : 'text-text-muted hover:bg-surface hover:text-text' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path>
                            </svg>
                            Laporan Penjualan
                        </a>
                        <a href="{{ route('admin.reports.menus') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl font-semibold t-size4 transition {{ request()->routeIs('admin.reports.menus') ? 'bg-primary-soft text-accent' : 'text-text-muted hover:bg-surface hover:text-text' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path>
                            </svg>
                            Performa Menu
                        </a>
                        <a href="{{ route('admin.reports.payments') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl font-semibold t-size4 transition {{ request()->routeIs('admin.reports.payments') ? 'bg-primary-soft text-accent' : 'text-text-muted hover:bg-surface hover:text-text' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z"></path>
                            </svg>
                            Metode Pembayaran
                        ...
                        <div class="pt-4 pb-2 text-[10px] uppercase font-bold text-text-muted/60 tracking-wider px-4">Otomatisasi RPA</div>
                        <a href="{{ route('admin.automations.index') }}" class="flex items-center gap-3 px-4 py-2.5 rounded-xl font-semibold t-size4 transition {{ request()->routeIs('admin.automations*') ? 'bg-primary-soft text-accent' : 'text-text-muted hover:bg-surface hover:text-text' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
